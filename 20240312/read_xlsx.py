...
# 讀取CSV檔案
df1 = pd.read_csv('C:\\Users\\User\\Desktop\\cycu_ai2024\\20240312\\112年1-10月交通事故簡訊通報資料.csv')

df1['國道名稱'] = df1['國道名稱'].fillna('')
df1 = df1[df1['國道名稱'].str.contains('國道3號')]
df1 = df1[df1['方向'].str.contains('北|北向')]
