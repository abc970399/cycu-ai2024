...
# 讀取並特徵化所有 CSV 檔案
features = []
for filename in os.listdir('D:/File/cycu_ai2024/20240507/data/TDCS_M05A_20240430.csv'):
    if filename.endswith('.csv'):
        df = pd.read_csv(os.path.join('D:/File/cycu_ai2024/20240507/data/TDCS_M05A_20240430.csv', filename), header=None)
...
for filename in os.listdir('D:/File/cycu_ai2024/20240507/data/TDCS_M05A_20240430.csv'):
    if filename.endswith('.csv'):
        df_speed = pd.read_csv(os.path.join('D:/File/cycu_ai2024/20240507/data/TDCS_M05A_20240430.csv', filename), header=None)
...
# 將特徵保存到 CSV 檔案
df.to_csv('D:/File/cycu_ai2024/20240507/data/TDCS_M05A_20240430-2.csv', index=False)
