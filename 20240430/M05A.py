...
for i in range(0,24):
    for j in range(0, 60, 5):
        time.sleep(1)
        url = 'https://tisvcloud.freeway.gov.tw/history/TDCS/M05A/20240429/' + str(i).zfill(2) + '/'
        filename = 'TDCS_M05A_20240429_' + str(i).zfill(2) + str(j).zfill(2) + '00.csv'
        urletc = url + filename
        print(urletc)
        # 從網路上讀取資料
...
merged_df.to_csv('C:/Users/User/Desktop/cycu_ai2024/20240430/collect4.csv', index=False)